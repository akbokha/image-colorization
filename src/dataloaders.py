...
def get_placeholder_loaders(placeholder_path, batch_size):
    ...
    train_loader = torch.utils.data.DataLoader(train_imagefolder, batch_size=batch_size, shuffle=True, num_workers=args.workers)
    ...
    val_loader = torch.utils.data.DataLoader(val_imagefolder, batch_size=batch_size, shuffle=False, num_workers=args.workers)
