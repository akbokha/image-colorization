...
print('GPU is available: {}'.format(use_gpu))


# The model which consist of ResNet-18-Gray followed by Deconvolutional Layers
...
# Custom dataloader to convert the images (LAB spacew)
...
if __name__ == '__main__':
    ...
    # optimizer for the our loss function
    optimizer = torch.optim.Adam(model.parameters(), lr=1e-2, weight_decay=0.0)

    # Data transformations of the images
    train_transforms = transforms.Compose([transforms.RandomResizedCrop(224), transforms.RandomHorizontalFlip()])
    train_imagefolder = GrayscaleImageFolder('data/images/train', train_transforms)
    train_loader = torch.utils.data.DataLoader(train_imagefolder, batch_size=64, shuffle=True)

    val_transforms = transforms.Compose([transforms.Resize(256), transforms.CenterCrop(224)])
    val_imagefolder = GrayscaleImageFolder('data/images/val', val_transforms)
